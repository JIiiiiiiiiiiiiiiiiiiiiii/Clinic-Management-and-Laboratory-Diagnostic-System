...
export default function AuthSimpleLayout({ children, title, description, user }: PropsWithChildren<AuthLayoutProps>) {
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col">
            {/* Navbar */}
            <SharedNavigation user={user} currentPath={typeof window !== 'undefined' ? window.location.pathname : '/'} />
