...
export default function PendingAppointmentPaymentModal({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const formData: any = {
            ...
            amount_paid: paid,
            discount_amount: discount, // CRITICAL: Include discount amount
            discount_percentage: data.discount_percentage || (totalAmount > 0 ? (discount / totalAmount) * 100 : 0), // Include discount percentage
