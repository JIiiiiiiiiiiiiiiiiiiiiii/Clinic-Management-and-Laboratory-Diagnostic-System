...
interface PendingAppointmentCreateModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSuccess: () => void;
    doctors: Doctor[];
...
export default function PendingAppointmentCreateModal({
    isOpen,
    onClose,
    onSuccess,
    doctors,
    patients
}: PendingAppointmentCreateModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/admin/billing/pending-appointments', {
            onSuccess: () => {
                onSuccess();
                onClose();
                // Reset form
    ...
    const handlePatientChange = (patientId: string) => {
        ...
        if (selectedPatient) {
            setData('patient_name', `${selectedPatient.first_name} ${selectedPatient.last_name}`);
            setData('patient_id', selectedPatient.patient_no);
        }
    };
