...
import { Save, User, Mail, Stethoscope, CheckCircle, X, Lock } from 'lucide-react';
...
export default function DoctorModal({ 
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const url = mode === 'create' 
            ? '/admin/specialists/doctors' 
            : `/admin/specialists/doctors/${doctor?.id}`;
            ...
            <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                    <DialogTitle className="flex items-center gap-2 text-xl">
                        ...
                        {mode === 'create' ? 'Create New Doctor' : mode === 'edit' ? 'Edit Doctor' : 'View Doctor'}
                    </DialogTitle>
                    <DialogDescription>
                        {mode === 'create' 
