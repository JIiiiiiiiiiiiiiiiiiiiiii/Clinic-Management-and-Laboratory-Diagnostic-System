...
export default function InventoryReports({
    ...
    const handleExport = (reportId: number, format: string) => {
        const exportUrl = `/admin/inventory/reports/${reportId}/export?format=${format}`;
        window.open(exportUrl, '_blank');
    };

    const handleDelete = (reportId: number) => {
        if (confirm('Are you sure you want to delete this report?')) {
            router.delete(`/admin/inventory/reports/${reportId}`);
        }
    };
                    ...
                    >
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <Button asChild variant="outline" className="h-auto p-4 flex flex-col items-center gap-2">
                                    <Link href="/admin/inventory/reports/stock-levels">
                                        <Package className="h-6 w-6" />
                                        <span>Stock Levels</span>
                                    </Link>
                                </Button>
                                <Button asChild variant="outline" className="h-auto p-4 flex flex-col items-center gap-2">
                                    <Link href="/admin/inventory/reports/daily-consumption">
                                        <Calendar className="h-6 w-6" />
                                        <span>Daily Consumption</span>
                                    </Link>
                                </Button>
                                <Button asChild variant="outline" className="h-auto p-4 flex flex-col items-center gap-2">
                                    <Link href="/admin/inventory/reports/usage-by-location">
