...
const DoctorNurseSupplies: React.FC<Props> = ({ items, stats }) => {
    ...
    return (
        <AppLayout>
            <Head title="Doctor & Nurse Clinical Supplies" />
                ...
                <div className="@container/main flex flex-1 flex-col gap-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h1 className="text-4xl font-semibold text-black mb-4">Doctor & Nurse Clinical Supplies</h1>
                                <p className="text-sm text-gray-600 mt-1">Manage medical supplies and equipment for clinical staff</p>
                            </div>
                        </div>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                        <Card className="holographic-card shadow-lg overflow-hidden rounded-lg bg-white/60 backdrop-blur-md border border-white/40 hover:bg-white/70 transition-all duration-300">
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium text-gray-600">Total Supplies</CardTitle>
                    ...
                    <Card className="holographic-card shadow-lg overflow-hidden rounded-lg bg-white/60 backdrop-blur-md border border-white/40">
                        <CardHeader>
                            <CardTitle className="text-xl font-semibold">Clinical Supplies Inventory</CardTitle>
                            <p className="text-sm text-gray-600 mt-1">Medical supplies and equipment for clinical staff</p>
                        </CardHeader>
                    <CardContent>
                                    ...
                                    <Textarea
                                        ...
                                        placeholder={
                                            actionType === 'consume' 
                                                ...
                                                : 'e.g. Damaged packaging, Expired product'
                                        }
                                        rows={3}
                                    />
...
export default DoctorNurseSupplies;
