...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Med Tech Items',
        href: '/admin/inventory/medtech',
    },
];
...
export default function MedTech({
    ...
    const [selectedItem, setSelectedItem] = useState<MedTechItem | null>(null);
    ...
    const handleConsumeClick = (item: MedTechItem) => {
    ...
    const handleRejectClick = (item: MedTechItem) => {
        setSelectedItem(item);
        setRejectForm({
            quantity: '',
            notes: '',
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="min-h-screen bg-white p-6">
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            <div>
                                <h1 className="text-4xl font-semibold text-black mb-4">Med Tech Inventory</h1>
                                <p className="text-sm text-black mt-1">Items assigned to Med Tech department</p>
                            </div>
                        </div>
                ...
                <div className="w-full">
                    <PatientInfoCard
                        title="Med Tech Items"
                        icon={<FlaskConical className="h-5 w-5 text-black" />}
                        actions={
                                                ...
                                                <TableCell colSpan={8} className="text-center py-8">
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        <h3 className="mb-2 text-lg font-semibold text-black">
                                                            {searchTerm ? 'No items found' : 'No items assigned to Med Tech'}
                                                        </h3>
