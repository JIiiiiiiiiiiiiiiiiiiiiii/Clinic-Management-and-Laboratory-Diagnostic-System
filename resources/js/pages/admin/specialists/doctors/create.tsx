...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create Doctor',
        href: '/admin/specialists/doctors/create',
    },
];
...
export default function DoctorCreate() {
    ...
    const submit: React.FormEventHandler = (e) => {
        e.preventDefault();
        router.post('/admin/specialists/doctors', data, {
            onSuccess: () => {
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            <div>
                                <h1 className="text-4xl font-semibold text-black mb-4">Create Doctor</h1>
                                <p className="text-sm text-black mt-1">Add a new doctor to the clinic</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4">
                            <div className="bg-white rounded-xl shadow-lg border px-6 py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="text-3xl font-bold text-black">New</div>
                                        <div className="text-black text-sm font-medium">Doctor Registration</div>
                                    </div>
                                </div>
                            </div>
                        </div>
