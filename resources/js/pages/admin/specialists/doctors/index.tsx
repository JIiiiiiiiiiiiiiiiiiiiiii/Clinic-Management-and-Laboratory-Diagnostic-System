...
export default function DoctorIndex({ doctors }: { doctors: Doctor[] }) {
    ...
    const confirmDelete = () => {
        if (doctorToDelete) {
            router.delete(`/admin/specialists/doctors/${doctorToDelete.id}`, {
                onSuccess: () => {
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">All medical doctors</p>
                                    </div>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-gray-900">{doctors.filter(d => d.is_active).length}</p>
