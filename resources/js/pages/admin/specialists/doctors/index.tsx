...
export default function DoctorIndex({ doctors }: { doctors: Doctor[] }) {
    ...
    const handleDelete = (doctorId: number) => {
        if (confirm('Are you sure you want to delete this doctor?')) {
            router.delete(`/admin/specialists/doctors/${doctorId}`);
        }
    };
                                            ...
                                            <TableRow key={doctor.id} className="hover:bg-gray-50">
                                                ...
                                                <TableCell>
                                                    <Badge
                                                        ...
                                                        className={doctor.is_active ? 'bg-gray-100 text-black' : 'bg-gray-100 text-gray-800'}
                                                    >
                                                ...
                                                <TableCell>
                                                    <div className="flex items-center gap-2">
                                                        <Link href={`/admin/specialists/doctors/${doctor.id}/edit`}>
                                                            <Button
                                                                variant="outline"
                                                                size="sm"
