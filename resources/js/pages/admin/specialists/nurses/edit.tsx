...
const breadcrumbs = (nurse: Nurse): BreadcrumbItem[] => [
    ...
    {
        title: 'Edit Nurse',
        href: `/admin/specialists/nurses/${nurse.id}/edit`,
    },
];
...
export default function NurseEdit({ nurse }: { nurse: Nurse }) {
    ...
    const submit: React.FormEventHandler = (e) => {
        e.preventDefault();
        router.put(`/admin/specialists/nurses/${nurse.id}`, data, {
            onSuccess: () => {
                            ...
                            <div className="bg-white rounded-xl shadow-lg border px-6 py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-black text-sm font-medium">Nurse Profile</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="bg-gray-50 p-4 rounded-lg">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div className="p-3 bg-white rounded-lg border">
                                            ...
                                            <Badge className={nurse.is_active ? 'bg-gray-100 text-black' : 'bg-gray-100 text-gray-800'}>
                                                {nurse.is_active ? 'Active' : 'Inactive'}
                                            </Badge>
                                        </div>
                                        <div className="p-3 bg-white rounded-lg border">
                                            <div className="text-sm font-medium text-gray-600 mb-1">Created</div>
                                            <div className="text-lg font-bold text-black">{new Date(nurse.created_at).toLocaleDateString()}</div>
                                        </div>
                                        <div className="p-3 bg-white rounded-lg border">
                                            <div className="text-sm font-medium text-gray-600 mb-1">Last Updated</div>
                                            <div className="text-lg font-bold text-black">{new Date(nurse.updated_at).toLocaleDateString()}</div>
                                        </div>
                                    </div>
                                </div>
