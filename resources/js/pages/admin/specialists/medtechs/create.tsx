...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Create Med Tech',
        href: '/admin/specialists/medtechs/create',
    },
];

export default function MedTechCreate() {
    ...
    const submit: React.FormEventHandler = (e) => {
        e.preventDefault();
        router.post('/admin/specialists/medtechs', data, {
            onSuccess: () => {
                router.visit('/admin/specialists/medtechs');
            },
            onError: (errors) => {
                console.error('Med tech creation failed:', errors);
            },
        });
    };
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            <div>
                                <h1 className="text-4xl font-semibold text-black mb-4">Create Med Tech</h1>
                                <p className="text-sm text-black mt-1">Add a new medical technologist to the clinic</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                ...
                                <div className="flex justify-end gap-4 pt-6 border-t border-gray-200">
                                    ...
                                    >
                                        ...
                                        {processing ? 'Creating...' : 'Create Med Tech'}
                                    </Button>
                                </div>
                            </form>
                        </CardContent>
