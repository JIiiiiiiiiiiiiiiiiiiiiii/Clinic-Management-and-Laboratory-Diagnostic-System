...
export default function AdminSpecialistManagementReports({ user, referrals, stats, dateRange, filters }: Props) {
  const breadcrumbs: BreadcrumbItem[] = [
    { title: 'Admin Dashboard', href: route('admin.dashboard') },
    { title: 'Reports', href: route('admin.reports.index') },
    { title: 'Specialist Management', href: route('admin.reports.specialist.management') },
  ];
  ...
  const handleFilter = () => {
    ...
    router.get(route('admin.reports.specialist.management'), Object.fromEntries(params), {
      preserveState: true,
      replace: true
    });
  };
  ...
  const handleExport = () => {
    ...
    window.location.href = `${route('admin.reports.export', 'specialist_management')}?${params.toString()}`;
  };
  ...
  return (
    <AppLayout breadcrumbs={breadcrumbs}>
      <Head title="Admin Specialist Management Reports" />
