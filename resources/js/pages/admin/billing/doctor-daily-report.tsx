...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Doctor Daily Report', href: '/admin/billing/doctor-daily-report' },
];
...
export default function DoctorDailyReport({ 
    ...
    const handleDateChange = () => {
        router.get('/admin/billing/doctor-daily-report', {
            date: selectedDate,
            doctor_id: doctorId,
            status: status,
        }, {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Doctor Daily Report" />
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Daily payments</p>
                                    </div>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Daily paid</p>
                                    </div>
                                    <div className="p-3 bg-green-100 rounded-full">
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-gray-900">{formatCurrency(summary.average_payment || 0)}</p>
                                            ...
                                            <TableRow>
                                                ...
                                                >
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        <p className="text-gray-500">No doctor payments for the selected date</p>
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                                        )}
