...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Yearly Report', href: '/admin/billing/doctor-summary-report/yearly' },
];

interface DoctorSummaryYearlyReportProps {
    doctorPayments: any[];
    revenueByDoctor: any[];
    summary: {
...
export default function DoctorSummaryYearlyReport({ 
    doctorPayments, 
    revenueByDoctor, 
    summary, 
    doctors, 
    year,
    filters 
}: DoctorSummaryYearlyReportProps) {
    const handleExport = (format: string) => {
        const params: any = { format, year, doctor_id: filters.doctor_id };
        const queryString = new URLSearchParams(params).toString();
        const exportUrl = `/admin/billing/doctor-summary-report/yearly/export?${queryString}`;
        window.open(exportUrl, '_blank');
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Doctor Summary Yearly Report - ${year}`} />
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            ...
                            <Heading 
                                title={`Doctor Summary Yearly Report`} 
                    ...
                    <CardContent className="p-6">
                        {doctorPayments.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 text-lg">No doctor payments found for this year</p>
                                <p className="text-gray-400 text-sm">Try selecting a different year or doctor</p>
                            </div>
                        )}
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-6">
                        {revenueByDoctor.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 text-lg">No revenue data found for this year</p>
                                <p className="text-gray-400 text-sm">Try selecting a different year or doctor</p>
                            </div>
                        )}
                    </CardContent>
