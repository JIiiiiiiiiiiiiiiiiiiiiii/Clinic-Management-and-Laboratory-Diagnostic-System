...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Doctor Monthly Report', href: '/admin/billing/doctor-monthly-report' },
];

export default function DoctorMonthlyReport({ 
    doctorPayments,
    summary,
    month,
    doctorId,
    ...
    const handleMonthChange = () => {
        router.get('/admin/billing/doctor-monthly-report', {
            month: selectedMonth,
            doctor_id: doctorId,
            status: status,
        }, {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Doctor Monthly Report" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-gray-900">{formatCurrency(summary.paid_amount || 0)}</p>
                        ...
                        <Card className="bg-white border border-gray-200">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-gray-600">Average Daily Payments</p>
                                        <p className="text-3xl font-bold text-gray-900">{summary.average_daily_payments || 0}</p>
                                            ...
                                            <TableRow>
                                                ...
                                                >
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        <p className="text-gray-500">No doctor payments for the selected month</p>
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                                        )}
