...
type Summary = {
    ...
    highest_revenue_day: string;
    lowest_revenue_day: string;
};
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'HMO Monthly Report', href: '/admin/billing/hmo-monthly-report' },
];

export default function HmoMonthlyReport({ 
    hmoTransactions,
    summary,
    month,
    hmoProvider
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Monthly HMO revenue</p>
                                    </div>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Monthly HMO transactions</p>
                                    </div>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-gray-900">₱{(summary.average_daily_revenue || 0).toLocaleString()}</p>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-gray-900">{(summary.approval_rate || 0).toFixed(1)}%</p>
                                        <p className="text-sm text-gray-500">Monthly approval rate</p>
                                    </div>
                    ...
                    <Card className="bg-white border border-gray-200">
                        <CardContent className="p-6">
                            ...
                            <div className="flex items-center py-4">
                                ...
                                <Button
                                    onClick={() => {
                                        const exportUrl = `/admin/billing/enhanced-hmo-report/export-data?month=${month}&format=excel&report_type=monthly`;
                                ...
                                <Button
                                    onClick={() => {
                                        const exportUrl = `/admin/billing/enhanced-hmo-report/export-data?month=${month}&format=pdf&report_type=monthly`;
                                        window.open(exportUrl, '_blank');
                                    }}
                                    variant="outline"
                                    className="ml-2"
                                            ...
                                            <TableRow>
                                                ...
                                                >
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        <p className="text-gray-500">No HMO transactions for the selected month</p>
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                                        )}
