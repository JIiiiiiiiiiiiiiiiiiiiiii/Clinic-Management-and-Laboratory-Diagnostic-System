...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'HMO Daily Report', href: '/admin/billing/hmo-daily-report' },
];

export default function HmoDailyReport({ 
    hmoTransactions,
    summary,
    date,
    hmoProvider
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Daily HMO revenue</p>
                                    </div>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Daily HMO transactions</p>
                                    </div>
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold text-gray-900">₱{(summary.total_approved_amount || 0).toLocaleString()}</p>
                                        <p className="text-sm text-gray-500">Daily approved claims</p>
                                    </div>
                                    <div className="p-3 bg-green-100 rounded-full">
                            ...
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-500">Daily approval rate</p>
                                    </div>
                    ...
                    <Card className="bg-white border border-gray-200">
                        <CardContent className="p-6">
                            ...
                            <div className="flex items-center py-4">
                                ...
                                <Button
                                    onClick={() => {
                                        const exportUrl = `/admin/billing/enhanced-hmo-report/export-data?date=${date}&format=excel&report_type=daily`;
                                ...
                                <Button
                                    onClick={() => {
                                        const exportUrl = `/admin/billing/enhanced-hmo-report/export-data?date=${date}&format=pdf&report_type=daily`;
                                        window.open(exportUrl, '_blank');
                                    }}
                                    variant="outline"
                                    className="ml-2"
                                            ...
                                            <TableRow>
                                                ...
                                                >
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        <p className="text-gray-500">No HMO transactions for the selected date</p>
                                                    </div>
                                                </TableCell>
                                            </TableRow>
                                        )}
