...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'HMO Report', href: '/admin/billing/enhanced-hmo-report' },
];
...
export default function EnhancedHmoReport({ 
    ...
    const handleDailyReport = () => {
        ...
        if (selectedProvider !== 'all') {
            params.hmo_provider = selectedProvider;
        }
        router.get('/admin/billing/hmo-daily-report', params);
    };
    ...
    const handleMonthlyReport = () => {
        ...
        router.get('/admin/billing/hmo-monthly-report', params);
    };
    ...
    const handleYearlyReport = () => {
        ...
        router.get('/admin/billing/hmo-yearly-report', params);
    };
