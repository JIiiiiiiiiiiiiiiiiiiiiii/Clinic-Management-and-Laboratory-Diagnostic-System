...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Monthly Report', href: '/admin/billing/doctor-summary-report/monthly' },
];

interface DoctorSummaryMonthlyReportProps {
    doctorPayments: any[];
    revenueByDoctor: any[];
    summary: {
...
export default function DoctorSummaryMonthlyReport({ 
    doctorPayments, 
    revenueByDoctor, 
    summary, 
    doctors, 
    month,
    filters 
}: DoctorSummaryMonthlyReportProps) {
    const handleExport = (format: string) => {
        const params: any = { format, month, doctor_id: filters.doctor_id };
        const queryString = new URLSearchParams(params).toString();
        const exportUrl = `/admin/billing/doctor-summary-report/monthly/export?${queryString}`;
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Doctor Summary Monthly Report - ${month}`} />
                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            ...
                            <Heading 
                                title={`Doctor Summary Monthly Report`} 
                                description={`Report for ${formatMonth(month)}`} 
                                icon={CalendarDays} 
                            />
                        </div>
                    ...
                    <CardContent className="p-6">
                        {doctorPayments.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 text-lg">No doctor payments found for this month</p>
                                <p className="text-gray-400 text-sm">Try selecting a different month or doctor</p>
                            </div>
                        )}
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="p-6">
                        {revenueByDoctor.length > 0 ? (
                            ...
                            <div className="text-center py-12">
                                ...
                                <p className="text-gray-500 text-lg">No revenue data found for this month</p>
                                <p className="text-gray-400 text-sm">Try selecting a different month or doctor</p>
                            </div>
                        )}
                    </CardContent>
