                ...
                <div className="mb-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            ...
                            <Heading title="Monthly Report" description={`Financial report for ${new Date(month + '-01').toLocaleDateString('en-US', { month: 'long', year: 'numeric' })}`} icon={Calendar} />
                        </div>
                ...
                <Card className="mb-6 rounded-xl border border-gray-200 bg-white shadow-sm">
                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center gap-4">
                            ...
                            <Button onClick={handleMonthChange} className="h-12 px-6">
