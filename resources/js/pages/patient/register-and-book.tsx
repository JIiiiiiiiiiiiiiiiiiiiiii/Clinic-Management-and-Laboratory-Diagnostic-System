...
interface RegisterAndBookProps {
    user: any;
    patient?: any;
    doctors: Doctor[];
    medtechs: Medtech[];
...
export default function RegisterAndBook({ 
    user, 
    patient,
    doctors = [], 
    medtechs = [], 
    ...
    const [currentStep, setCurrentStep] = useState(1); // Always start at step 1 for all patients
    ...
    const submit: React.FormEventHandler = (e) => {
        ...
        // If we reach here, it means we're on the final step or it's an existing patient
        // The final submission will be handled by the handleFinalSubmit function
        console.log('Final step reached, but submission handled by button click');
    };

    const proceedDuplicate = () => {
        setData('force_create', true as any);
        post(route('patient.register.and.book.force'), { preserveScroll: true, preserveState: true });
    };
    ...
    const handleFinalSubmit = () => {
        console.log('Final submit triggered!', { data, isExistingPatient });
        ...
        if (missing.length > 0) {
            console.log('Missing fields found:', missing);
    ...
    const handleSpecialistChange = (specialistId: string) => {
        console.log('Specialist changed:', specialistId);
                    ...
                    <Card className="holographic-card shadow-lg overflow-hidden rounded-xl bg-white/70 backdrop-blur-md border border-white/50">
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
                            ...
                            <Badge variant="outline" className="bg-gray-50 text-black border-gray-200">
                                {(() => {
                                    // If on step 6 and appointment fields are not filled, show 83% (5/6)
                        ...
                        <Card className="bg-blue-50 border-blue-200">
                            <CardContent className="p-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-blue-900 mb-2">How the Registration & Booking Process Works</h3>
                                        ...
                                        <div className="grid gap-4 md:grid-cols-2">
                                            <div className="space-y-2">
                                                ...
                                                <Select onValueChange={(value) => {
                                                    console.log('Appointment type changed:', value);
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="grid gap-4 md:grid-cols-2">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select onValueChange={(value) => {
                                                    console.log('Appointment time changed:', value);
