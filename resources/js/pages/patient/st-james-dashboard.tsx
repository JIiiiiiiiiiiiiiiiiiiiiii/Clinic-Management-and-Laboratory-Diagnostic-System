...
import { Calendar, Clock, MapPin, Phone, Star, Heart, Shield, Users, Stethoscope, Award, Bell, CheckCircle, TrendingUp, Activity } from 'lucide-react';
import { Link } from '@inertiajs/react';
import RealtimeNotificationBell from '@/components/RealtimeNotificationBell';

interface StJamesDashboardProps {
    user: {
        name: string;
        email: string;
        role: string;
...
export default function StJamesDashboard({ 
    user, 
    patient, 
    stats, 
    recent_appointments, 
            ...
            <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-yellow-50">
                ...
                <div className="container mx-auto px-4 py-8">
                            ...
                            <div className="space-y-4">
                                {upcoming_appointments.map((appointment) => (
                                    <div key={appointment.id} className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
                                        ...
                                        <Badge variant={appointment.is_today ? "default" : "secondary"} className="bg-green-100 text-green-800">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
                        <Card className="text-center p-6 hover:shadow-lg transition-shadow border-0 rounded-xl bg-white">
                            <div className="bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-12">
                        <Card className="p-8 border-0 rounded-xl bg-white shadow-lg">
                        ...
                        <Card className="p-6 border-0 rounded-xl bg-white shadow-lg">
                            ...
                            <div className="space-y-3">
                                <p className="text-gray-700">
                                    <strong>Address:</strong> St. James Hospital, Inc.<br />
                                    Industrial Clinic and Diagnostic Center<br />
                                    Brgy. San Isidro, City of Cabuyao, Laguna
                                </p>
                                <p className="text-gray-700">
                                    <strong>Phone:</strong> (049) 123-4567
                                </p>
                                <p className="text-gray-700">
                                    <strong>Email:</strong> info@stjameshospital.com
                                </p>
                            </div>
                        </Card>
                    ...
                    {/* Why Choose Us */}
                    <Card className="p-8 text-center border-0 rounded-xl bg-white shadow-lg">
                        <h2 className="text-3xl font-bold mb-6">Why Choose St. James Hospital?</h2>
