...
export default function HospitalTransferReports({ user, transfers, stats, dateRange, filters }: Props) {
  ...
  const handleFilter = () => {
    router.get(route('hospital.reports.transfers'), {
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Patient transfer analytics and data for {dateRange.label}
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {transfers.meta.total} transfers found
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <TableBody>
                  {transfers.data.map((transfer) => (
                    <TableRow key={transfer.id}>
                      ...
                      <TableCell>
                        <div className="font-medium">
                          {transfer.from_clinic?.name || 'Hospital'}
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="font-medium">
                          {transfer.to_clinic?.name || 'Hospital'}
                        </div>
                      </TableCell>
                      <TableCell>
                        <div>
