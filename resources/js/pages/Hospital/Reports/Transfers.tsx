...
import { AlertCircle, ArrowRightLeft, Calendar, CheckCircle, Filter, Search, User, XCircle } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 px-4 md:px-6">
                ...
                <PageHeader
                    ...
                    description={`Patient transfer analytics and data for ${dateRange.label}`}
