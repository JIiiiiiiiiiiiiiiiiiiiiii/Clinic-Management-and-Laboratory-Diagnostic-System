...
export default function HospitalInventoryReports({ user, transactions, stats, dateRange, filters }: Props) {
  ...
  const handleFilter = () => {
    router.get(route('hospital.reports.inventory'), {
  ...
  const exportReport = () => {
    ...
    window.open(route('hospital.reports.export', 'inventory') + '?' + params.toString());
  };
  ...
  const getTransactionBadge = (type: string) => {
    ...
    return (
      <Badge variant={variants[type.toLowerCase() as keyof typeof variants] || 'outline'}>
        {type}
      </Badge>
    );
  };
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Supply and inventory management analytics for {dateRange.label}
            </p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Filter inventory transactions by various criteria
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                <TableBody>
                  {transactions.data.map((transaction) => (
                    <TableRow key={transaction.id}>
                      ...
                      <TableCell>
                        <div className="font-medium">
                          ₱{transaction.unit_cost.toLocaleString()}
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="font-medium">
