...
import { DollarSign, Download, Filter, Minus, Package, Search, TrendingDown, TrendingUp, User } from 'lucide-react';
...
export default function HospitalInventoryReports({ user, transactions, stats, dateRange, filters }: Props) {
    ...
    const exportReport = () => {
        ...
        link.href = route('hospital.reports.export', 'inventory') + '?' + params.toString();
