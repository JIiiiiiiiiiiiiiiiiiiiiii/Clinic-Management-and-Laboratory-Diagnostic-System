...
export default function EditHospitalUser({ user, userId }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        name: 'Hospital Staff Member', // Mock data
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(route('hospital.users.update', userId));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Edit User - Hospital" />
