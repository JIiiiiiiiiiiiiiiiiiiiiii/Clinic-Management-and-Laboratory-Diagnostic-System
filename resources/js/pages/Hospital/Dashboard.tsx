        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              St. James Hospital - Patient Management & Clinic Operations
            </p>
          </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest patient transfers to St. James Clinic
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <div className="space-y-1">
                        ...
                        {patient.transfers.length > 0 && (
                          <div className="text-xs text-muted-foreground">
                            {patient.transfers[0].transfer_reason}
                          </div>
                        )}
                      </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Overview of clinic activities and performance
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="text-center p-3 bg-yellow-50 rounded-lg">
                    <div className="text-2xl font-bold text-yellow-600">
                      {clinicOperations.pending_appointments}
                    </div>
                    <div className="text-sm text-yellow-600">Pending</div>
                  </div>
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">
                      {clinicOperations.lab_orders}
                    </div>
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-gray-600">
                      ₱{clinicOperations.total_billing.toLocaleString()}
                    </div>
