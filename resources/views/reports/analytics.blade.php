...
<body>
    ...
    <div class="summary-section">
        <div class="summary-title">Clinic Analytics Summary</div>
        <div class="summary-grid">
            ...
            <div class="summary-item">
                <div class="summary-value">{{ number_format($data['summary']['total_appointments']) }}</div>
            ...
            <div class="summary-item">
                <div class="summary-value">{{ number_format($data['summary']['total_lab_orders']) }}</div>
                <div class="summary-label">Total Lab Orders</div>
            </div>
        </div>
    </div>
