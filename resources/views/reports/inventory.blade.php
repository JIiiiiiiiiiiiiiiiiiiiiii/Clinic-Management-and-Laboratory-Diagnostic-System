...
<body>
    ...
    <div class="summary-section">
        ...
        <div class="summary-grid">
            <div class="summary-item">
                <div class="summary-value">{{ number_format($data['summary']['total_products']) }}</div>
                <div class="summary-label">Total Products</div>
            </div>
            <div class="summary-item">
                <div class="summary-value">{{ number_format($data['summary']['low_stock']) }}</div>
                <div class="summary-label">Low Stock</div>
            </div>
            <div class="summary-item">
                <div class="summary-value">{{ number_format($data['summary']['out_of_stock']) }}</div>
    ...
    <div class="table-section">
        <div class="table-title">Inventory Details</div>
                ...
                <tbody>
                    @foreach($data['supplies'] as $supply)
                        <tr>
                            ...
                            <td>{{ number_format($supply->current_stock ?? 0) }}</td>
                            <td>₱{{ number_format($supply->unit_cost ?? 0, 2) }}</td>
                            <td>₱{{ number_format($supply->total_value ?? 0, 2) }}</td>
                            <td>{{ $supply->supplier_name ?? 'N/A' }}</td>
                            <td>{{ $supply->current_stock <= 0 ? 'Out of Stock' : ($supply->current_stock <= $supply->minimum_stock_level ? 'Low Stock' : 'In Stock') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
        @else
            <div class="no-data">No inventory items found for the selected period.</div>
        @endif
    </div>
